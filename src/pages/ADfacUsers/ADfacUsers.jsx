...
const UsersPage = ({ role }) => {
  ...
  const handleEditSubmit = async () => {
    ...
    if (
      ...
      toastService.error(
        "Parollar kiritilganini va to'g'ri tastiqlangani tekshiring",
      );
      return;
    }
            ...
            <SimpleGrid columns={{ base: 2, md: 5 }} spacing={4}>
              {roleStats.map(({ role, count, label, color }) => (
                <Card
                  ...
                  borderWidth="2px"
                  borderColor={
                    roleFilter === role ? `${color}.500` : "transparent"
                  }
              ...
              <VStack spacing={4} py={12}>
                ...
                <VStack spacing={2}>
                  <Text fontSize="lg" fontWeight="medium" color="text">
                    {roleFilter !== "all"
                      ? "Bu lavozimda foydalanuvchi yo'q"
                    ...
                    <VStack align="stretch" spacing={4}>
                      ...
                      <HStack justify="space-between" align="start">
                        <VStack align="start" spacing={2} flex={1}>
                          ...
                          <HStack justify="space-between">
                            <Text color="gray.600">Telefon:</Text>
                            <Text color="text" fontWeight="medium">
                              {user.phone ? `${user.phone}` : "Berilmagan"}
                            </Text>
                          </HStack>
                        </VStack>
                ...
                <TabPanel>
                  <VStack spacing={4}>
                    ...
                    <FormControl>
                      <FormLabel color="text">Lavozim</FormLabel>
                      <Badge
                        colorScheme={roleConfig[formData.role]?.color || "gray"}
                        fontSize="md"
                        p={2}
                      >
                ...
                >
                  <CardBody>
                    <VStack align="start" spacing={2}>
                      ...
                      <Badge
                        colorScheme={
                          roleConfig[currentUser.role]?.color || "gray"
                        }
                      >
