...
class apiStock {
    ...
    static UpdateSalePrice = async (id, data, stock_id) => {
        const response = await $api.put(`/erp/stock-sale-type/${id}/${stock_id}`, data, { showSuccessToast: 'Sotuv narxi yangilandi' });
        return response;
    }
