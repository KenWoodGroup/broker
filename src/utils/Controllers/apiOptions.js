...
class apiOptions {
    static getAll = async () => {
        const response = await $api.get(`${BASE_URL}/api/erp/options`)
        return response;
    }
    ...
    static Add = async (data ) => {
        const response = await $api.post(`${BASE_URL}/api/erp/options`, data, { showSuccessToast: "Opsiya successfully created" })
        return response;
    }
    static Update = async (data, id) => {
        const response = await $api.put(`${BASE_URL}/api/erp/options/${id}`, data, { showSuccessToast: "Opsiya successfully updated" })
        return response;
    }
    ...
    static DeleteOption = async (id) => {
        const response = await $api.delete(`${BASE_URL}/api/erp/options/${id}`, { showSuccessToast: "Opsiya successfully deleted" })
        return response;
    }
}
